app.docker.compositions.applications.form = (resolution) =>
a['app-docker-compositions-applications-form']([
  app.jsonForm({
    ...
    buttonless: true,
    success: (_, el) => {
      el.$('^app-docker-compositions-applications-application app-docker-compositions-applications-stale').$nodes = []
