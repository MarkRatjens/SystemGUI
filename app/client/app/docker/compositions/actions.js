app.docker.compositions.actions = (composition) => a['app-docker-compositions-actions']([
  ...[
    ...
    title: command[0],
    buttonTag: {
      $target: (el) => () => el.$(`^app-docker-compositions-composition app-docker-compositions-${command[2]}`),
      $close: (el) => () => {
