app.dashboard.menu.arenas.applications.application = (route, application) => (a,x) => {
  let [arenaIdentifier, blueprintIdentifier] = application.identifier.split('::')

  return app.button({
    label: a['div.position-relative']([
      a['div.position-relative'](app.icon('fa fa-angle-right', blueprintIdentifier)),
      a['div.position-absolute.error'](app.icon('fa fa-exclamation-circle'), {
